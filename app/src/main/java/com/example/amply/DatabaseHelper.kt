...
//        private const val DATABASE_VERSION = 3 // increment if schema changes
...
//        db.close()
//        Log.d("DBHelper", "Added user: $email | result=$result")
//        return result != -1L
//    }
//
...
//        cursor.close()
//        db.close()
//        Log.d("DBHelper", "Check user $email exists=$exists")
//        return exists
//    }
//
...
//        cursor.close()
//        db.close()
//        Log.d("DBHelper", "Validate user $email | valid=$valid")
//        return valid
//    }
//
//    fun clearUsers() {
...
//        db.close()
//        Log.d("DBHelper", "Cleared all users")
//    }
//
//    fun logAllUsers() {
//        val db = readableDatabase
...
//                Log.d("DBHelper", "User: $email | Password: $password")
